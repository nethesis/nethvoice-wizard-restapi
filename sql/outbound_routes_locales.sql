...
INSERT IGNORE INTO `outbound_routes_locales` (`locale`,`key`,`prefix_value`,`pattern_value`) VALUES ('it','payment','','12XX');
INSERT IGNORE INTO `outbound_routes_locales` (`locale`,`key`,`prefix_value`,`pattern_value`) VALUES ('it','payment','','144XXX.');
INSERT IGNORE INTO `outbound_routes_locales` (`locale`,`key`,`prefix_value`,`pattern_value`) VALUES ('it','payment','','166XXX.');
INSERT IGNORE INTO `outbound_routes_locales` (`locale`,`key`,`prefix_value`,`pattern_value`) VALUES ('it','payment','','178XXX.');
INSERT IGNORE INTO `outbound_routes_locales` (`locale`,`key`,`prefix_value`,`pattern_value`) VALUES ('it','payment','','199XXX.');
INSERT IGNORE INTO `outbound_routes_locales` (`locale`,`key`,`prefix_value`,`pattern_value`) VALUES ('it','payment','','702XXX.');
INSERT IGNORE INTO `outbound_routes_locales` (`locale`,`key`,`prefix_value`,`pattern_value`) VALUES ('it','payment','','8ZXXXX.');
...
INSERT IGNORE INTO `outbound_routes_locales` (`locale`,`key`,`prefix_value`,`pattern_value`) VALUES ('fr','payment','','08XXXX.');
...
INSERT IGNORE INTO `outbound_routes_locales` (`locale`,`key`,`prefix_value`,`pattern_value`) VALUES ('es','payment','','80ZXXX.');
INSERT IGNORE INTO `outbound_routes_locales` (`locale`,`key`,`prefix_value`,`pattern_value`) VALUES ('es','payment','','90ZXXX.');
...
INSERT IGNORE INTO `outbound_routes_locales` (`locale`,`key`,`prefix_value`,`pattern_value`) VALUES ('de','payment','','0900XX.');
INSERT IGNORE INTO `outbound_routes_locales` (`locale`,`key`,`prefix_value`,`pattern_value`) VALUES ('de','payment','','01[2389]XX.');
...
INSERT IGNORE INTO `outbound_routes_locales` (`locale`,`key`,`prefix_value`,`pattern_value`) VALUES ('en','payment','','084XXX.');
INSERT IGNORE INTO `outbound_routes_locales` (`locale`,`key`,`prefix_value`,`pattern_value`) VALUES ('en','payment','','087XXX.');
INSERT IGNORE INTO `outbound_routes_locales` (`locale`,`key`,`prefix_value`,`pattern_value`) VALUES ('en','payment','','09XXX.');
UNLOCK TABLES;
